...
import {
  ...
  Sun,
  Droplets,
  KeyRound, // ADDED: for password icon
  X, // ADDED: for close button
} from "lucide-react";
import { fetchFarmerProfile, changePassword } from "../../apis/api"; // ADDED: changePassword import
...
const Profile = () => {
  ...
  // ADDED: State for password modal and form
  const [showPasswordModal, setShowPasswordModal] = useState(false);
  const [newPassword, setNewPassword] = useState("");
  const [confirmPassword, setConfirmPassword] = useState("");
  const [loading, setLoading] = useState(false);

  // ADDED: Handler for changing password
      ...
      <div className="min-h-screen bg-linear-to-br from-green-50 via-emerald-50 to-teal-50 rounded-2xl">
              ...
              <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-green-100 p-8">
                <div className="flex items-center flex-wrap justify-between mb-8">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 mt-5  md:gap-3 p-3 md:px-6 md:py-3 text-sm bg-linear-to-r from-orange-500 to-amber-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition transform hover:scale-105"
                  >
        ...
        {showPasswordModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              <div className="bg-linear-to-r from-emerald-600 to-green-700 p-6 text-white">
              ...
              <form onSubmit={handleChangePassword} className="p-8 space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-2xl border-2 border-green-200 focus:border-green-500 outline-none transition text-gray-800"
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    type="button"
                    onClick={closePasswordModal}
                    className="flex-1 py-4 rounded-2xl bg-gray-100 hover:bg-gray-200 font-semibold text-gray-700 transition"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 py-4 rounded-2xl bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold shadow-lg transition disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
